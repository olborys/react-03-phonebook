...
class App extends Component {
  ...
  // Savening contacts in localstorage

  componentDidMount() {
    const contacts = localStorage.getItem('items'); //get data from localstorage
    const parsedContacts = JSON.parse(contacts); // переформатовуємо з строки json в обєкт js
    if (parsedContacts) {
